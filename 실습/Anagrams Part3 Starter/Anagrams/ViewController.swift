...
class ViewController: UIViewController {
    ...
    func ShowLevelMenu(){
        ...
        let hard = UIAlertAction(title: "Challenge accecpted", style: .default, handler: {(alert: UIAlertAction) in
            self.showLevel(2)
        })
        let hardest = UIAlertAction(title: "I'm totally hard-core", style: .default, handler: {(alert: UIAlertAction) in
            self.showLevel(3)
        })
